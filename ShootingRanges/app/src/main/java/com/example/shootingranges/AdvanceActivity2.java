...
public class AdvanceActivity2 extends AppCompatActivity {

    public String id,name,phone;
    TextView txtAdvId,txtAdvName,txtAdvcourse,txtAdvfees,txtAdvStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Advance Course Application Form");
        ...
        txtAdvId=(TextView)findViewById(R.id.txtVwAdvId);
        txtAdvName=(TextView)findViewById(R.id.txtVwAdvName);
        txtAdvcourse=(TextView)findViewById(R.id.txtVwAdvCourse);
        txtAdvfees=(TextView)findViewById(R.id.txtVwAdvFees);
        txtAdvStatus=(TextView)findViewById(R.id.txtVwAdvStatus);

        txtAdvId.setText(id);
        txtAdvName.setText(name);


        mCreateButton = (Button) findViewById(R.id.btnAdvPdf);
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        pdfFile = new File(docsFolder.getAbsolutePath(),"Advance Application Form.pdf");
        ...
        TextView txt_status=(TextView)findViewById(R.id.textView6);
        ...
        String id2="  ";
        String id3=txtAdvId.getText().toString();
        String id4=id1+"\t\t"+id3;
        ...
        String name2=txtAdvName.getText().toString();
        ...
        String course2=txtAdvcourse.getText().toString();
        ...
        String fees2=txtAdvfees.getText().toString();
        ...
        document.add(new Paragraph("\n"));
        String status1=txt_status.getText().toString();
        String status2=txtAdvStatus.getText().toString();
        String status3=status1+status2;
        document.add(new Paragraph(status3));
    ...
    {
        Intent intent=new Intent(AdvanceActivity2.this,MenuActivity.class);
        //startActivity(intent);
        finish();
    }
}
